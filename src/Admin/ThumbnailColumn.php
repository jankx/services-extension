...
/**
 * Adds a thumbnail column to the "service" post type list screen.
 *
...
class ThumbnailColumn
{
    ...
    {
        add_filter('manage_service_posts_columns', [$this, 'addThumbnailColumn']);
        add_action('manage_service_posts_custom_column', [$this, 'renderThumbnailColumn'], 10, 2);
